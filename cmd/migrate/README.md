...
$ # Go 1.16+
$ go install -tags 'postgres' github.com/abramad-labs/histomigrate/cmd/migrate@$TAG
```
...
$ # Go 1.16+
$ go install -tags 'postgres' github.com/abramad-labs/histomigrate/cmd/migrate@latest
```
